<!-- agent:begin -->
*Shipping log for the 7 days to 2026-08-07, derived from the [public GitHub events API](https://api.github.com/users/ElliotJLT/events/public). 80 commits across 4 repos.*
...
- **[elliot-os](https://github.com/ElliotJLT/elliot-os)**: 27 commits. "Merge pull request #21 from ElliotJLT/ElliotJLT/enlarge-nav-add-dropdowns" (a13b417), "Polish Loops navigation and hero effects" (7a1855b), "Merge pull request #20 from ElliotJLT/ElliotJLT/enlarge-nav-add-dropdowns" (8435244) and 24 more
- **[boulot-os](https://github.com/ElliotJLT/boulot-os)**: 17 commits. "Drop the withdrawal note, and say who the instructions belong to" (99b7443), "Landing page: what it does for the person, not who it is fighting" (b938488), "Six chips into four, grouped by what each one measures" (62f4cd1) and 14 more
